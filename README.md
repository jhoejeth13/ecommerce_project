...
# Link
client side: https://localhost/ecommerce_project_melodyvistal/index.php
admin side: https://localhost/ecommerce_project_melodyvistal/admin/index.php
...
# Melody Online-Food-Ordering-System
