                                    ...
                                    <div class="food-item">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-lg-4 pull-right item-cart-info"> 
                                                ...
                                                <input type="number" class="pull-left b-r-10" name="quantity" value="1" min="1" style="width: 50px; margin-top: 5px;">
                                                <button type="submit" class="btn theme-btn-dash pull-right"><i class="fa fa-cart-plus"></i> Add to Cart</button>
                                                </form>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
