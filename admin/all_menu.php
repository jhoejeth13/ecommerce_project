    ...
    <div id="main-wrapper">
          ...
          <div class="header">
            ...
            <div class="navbar-header">
                    ...
                    <span class="tagline">Your Cravings, We Deliver</span>                    </a>
                </div>
																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																				...
																				$fetch=mysqli_fetch_array($newquery);
																					...
																					echo '<tr><td>'.$fetch['title'].'</td>
																								...
																								<center><img src="Res_img/dishes/'.$rows['img'].'" class="img-responsive  radius" style="max-height:600px;max-width:600px;" /></center>
																								</div></td>
