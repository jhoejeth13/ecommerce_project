...
error_reporting(0);
session_start();
include 'functions.php'; // Ensure functions.php is secure
...
// Sanitize input
$res_id = mysqli_real_escape_string($db, $_GET['res_id']);
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <span class="tagline">Your Cravings, We Deliver</span>                      <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        ...
                        <div class="row">
                           <div class="col-xs-12 col-sm-3 payment-options color-gray">
                              ...
                              <ul>
                                 ...
                                 <li>
                                    <a href="#"> <img src="images/gcash (2).png" alt="Gcash"> </a>
                                 </li>
                                 <li>
